  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/categories/:categoryId/folders/:id" element={<ProtectedRoute permission="folder.view"><FoldersPage /></ProtectedRoute>} />
        ...
        <Route path="/administrators" element={<ProtectedRoute permission="admin.view"><UsersPage adminMode /></ProtectedRoute>} />
